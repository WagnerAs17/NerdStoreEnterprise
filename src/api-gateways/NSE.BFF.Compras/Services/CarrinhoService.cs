...
namespace NSE.BFF.Compras.Services
{
    public interface ICarrinhoService
    {
        ...
        Task<ResponseResult> AdicionarItemCarrinho(ItemCarrinhoDTO itemCarrinhoDto);
    ...
    public class CarrinhoService : Service, ICarrinhoService
    {
        ...
        public async Task<ResponseResult> AdicionarItemCarrinho(ItemCarrinhoDTO itemCarrinhoDto)
        {
            var stringContent = ObterDado(itemCarrinhoDto);

            var response = await _httpClient.PostAsync($"/carrinho", stringContent);
        ...
        {
            var stringContent = ObterDado(produto);

            var response = await _httpClient.PutAsync($"carrinho/{produtoId}", stringContent);
        ...
        public async Task<ResponseResult> AplicarVoucherCarrinho(VoucherDTO voucher)
        {
            ...
            var response = await _httpClient.PostAsync("/carrinho/aplicar-voucher", stringContent);
